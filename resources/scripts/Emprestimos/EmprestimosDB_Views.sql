...
FROM EMPRESTIMO e
JOIN usr_emprestimosdb.snap_leitor           l  ON e.num_cartao  = l.num_cartao
JOIN usr_emprestimosdb.snap_material         mb ON e.cod_material = mb.cod_material
JOIN usr_emprestimosdb.biblioteca_snap       bs ON l.cod_biblioteca = bs.cod_biblioteca
LEFT JOIN usr_emprestimosdb.snap_professor   pr ON e.num_cartao  = pr.num_cartao
LEFT JOIN usr_emprestimosdb.snap_crianca     cr ON e.num_cartao  = cr.num_cartao
...
FROM EMPRESTIMO e
JOIN usr_emprestimosdb.snap_leitor           l  ON e.num_cartao      = l.num_cartao
LEFT JOIN usr_emprestimosdb.repl_funcionarios f  ON e.cod_funcionario = f.cod_funcionario
LEFT JOIN usr_emprestimosdb.biblioteca_snap  bs ON l.cod_biblioteca  = bs.cod_biblioteca
JOIN usr_emprestimosdb.snap_material         mb ON e.cod_material    = mb.cod_material
JOIN usr_emprestimosdb.snap_categoria        c  ON mb.cod_categoria  = c.id_categoria
LEFT JOIN usr_emprestimosdb.snap_professor   p  ON l.num_cartao      = p.num_cartao
LEFT JOIN usr_emprestimosdb.snap_adulto      a  ON l.num_cartao      = a.num_cartao
LEFT JOIN usr_emprestimosdb.snap_crianca     cr ON l.num_cartao      = cr.num_cartao;
